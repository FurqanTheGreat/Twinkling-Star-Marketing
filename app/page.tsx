...
export default function App() {
  return (
    ...
    <AuroraBackground>
        ...
        Welcome to Twinkling Star, where comfort meets convenience. Nestled in the heart of Karachi, our guest house offers a cozy and serene environment that makes every stay feel like home. Whether you're here for a relaxing getaway or a short business trip, our attention to detail ensures a memorable experience. <br /> <br />
        ...
        Come experience the perfect blend of homely warmth and professional service. Whether it’s your first time staying with us or you’re a returning guest, we look forward to welcoming you to Twinkling Star. <br /> <br />
        </div>
